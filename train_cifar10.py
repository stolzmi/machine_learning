"""
Training script for CIFAR-10 CNN with Flax
"""
...
def create_train_state(rng, learning_rate: float = 0.001):
    ...
    params, batch_stats, model = initialize_model(init_rng, input_shape=(1, 32, 32, 3))
...
def load_cifar10_data(batch_size: int = 128, train_split: float = 0.9):
    """
    ...
    def normalize_img(data):
        """Normalize images to [0, 1] range and prepare for JAX"""
...
def train_model(num_epochs: int = 50, batch_size: int = 128, learning_rate: float = 0.001,
                save_path: str = 'cifar10_model.pkl'):
    """
    Full training loop
    ...
    import tensorflow as tf
    train_ds, val_ds, test_ds, info = load_cifar10_data(batch_size)
...
if __name__ == '__main__':
    ...
    print("\nTraining complete! Model saved to 'cifar10_model.pkl'")
